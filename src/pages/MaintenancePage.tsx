  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-white mb-2">{t.maintenance.title}</h1>
          <p className="text-gray-400">{t.maintenance.scheduled}</p>
        </div>
        ...
        <Card dark glass>
          <CardContent className="p-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-sm text-gray-400">{t.maintenance.type}</p>
        ...
        <Card dark glass>
          <CardContent className="p-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-sm text-gray-400">{t.maintenance.cost}</p>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-dark-border">
                  <th className="text-left py-3 px-4 text-sm font-semibold text-gray-400">{t.maintenance.date}</th>
                  <th className="text-left py-3 px-4 text-sm font-semibold text-gray-400">{t.vehicles.title}</th>
                  <th className="text-left py-3 px-4 text-sm font-semibold text-gray-400">{t.maintenance.serviceType}</th>
                  <th className="text-left py-3 px-4 text-sm font-semibold text-gray-400">{t.vehicles.odometer}</th>
                  <th className="text-left py-3 px-4 text-sm font-semibold text-gray-400">{t.maintenance.cost}</th>
                  <th className="text-left py-3 px-4 text-sm font-semibold text-gray-400">{t.maintenance.notes}</th>
                  <th className="text-left py-3 px-4 text-sm font-semibold text-gray-400">{t.maintenance.pending}</th>
                </tr>
              </thead>
              <tbody>
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title={t.maintenance.title} maxWidth="lg" dark>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end space-x-3 pt-4">
            ...
            <Button type="submit">{t.maintenance.scheduled}</Button>
          </div>
        </form>
      </Modal>
    </div>
